...
| **Mothership PocketBase v0.39** | Med | M | Upgrade control-plane PB; run migrations, retest hooks/handlers, instance-app typed defs, allowed semver range. **Pre-v0.39 on `main`:** dual-auth CLI + deps refresh shipped 2026-06-14. Legacy SQL views dropped on 0.22 — no cutover-day preupgrade SQL. |
