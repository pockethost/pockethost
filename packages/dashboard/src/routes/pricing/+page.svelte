  ...
  <main>
    <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-32 lg:px-8">
      <div class="mx-auto max-w-4xl text-center">
        <h1 class="text-base font-semibold leading-7 text-primary">Pricing</h1>
      </div>

      <div class="text-neutral-content w-96 m-auto">
        PocketHost is made for indie hackers, makers, and small businesses. Our
        pricing is simple and transparent. We offer a free tier, a premium tier,
        and a limited supply of lifetime tiers while we bootstrap. <a
          href="/docs/pricing-ethos"
          class="link">Read more about our pricing ethos</a
        >
      </div>
