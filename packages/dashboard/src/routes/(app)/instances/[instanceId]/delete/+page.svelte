...
<FeatureTab
  ...
  powerOffMessage="Instance must be powered off before deleting."
  {errorMessage}
>
  <svelte:fragment slot="summary">
    <p>Deleting your instance is immediate and permanent. Everything below will be removed from PocketHost.</p>
  </svelte:fragment>
