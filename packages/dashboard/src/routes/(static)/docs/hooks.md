...
Every PocketHost instance comes with a `pb_hooks` directory accessible via [SFTP](/docs/ftp). When your PocketBase instance runs, the contents are mounted at `/pb_hooks`. This directory is where you can place your custom server-side code.
