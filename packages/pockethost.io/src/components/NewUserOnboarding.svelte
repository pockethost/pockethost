...
{#if $isFirstTimeRegistration}
	<div class="modal fade" id="onboarding-modal" tabindex="-1" aria-labelledby="onboarding-modal-label" aria-hidden="true">
			...
			<div class="modal-content">
				<div class="modal-body text-center">
					...
					<div id="modal-indicators" class="carousel slide" data-bs-ride="true">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<div class="carousel-item-content">
									Make sure to verify your account via your email to take advantage of all of PocketHost's features.
								</div>
							</div>
							<div class="carousel-item">
								<div class="carousel-item-content">
									You can use 200 minutes for free
								</div>
							</div>
							<div class="carousel-item">
								<div class="carousel-item-content">
						...
						<button class="carousel-control-prev" type="button" data-bs-target="#modal-indicators" data-bs-slide="prev">
							<i class="bi bi-chevron-left"></i>
							<span class="visually-hidden">Previous</span>
						</button>
						<button class="carousel-control-next" type="button" data-bs-target="#modal-indicators" data-bs-slide="next">
