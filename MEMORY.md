...
**Hard paywall** — no free hosting tier. **Pay Per PocketBase:** $5/mo per slot. Each slot = one powered-on PocketBase + 250 MB DB + 10 GB file storage (pooled). Unlimited instance records; powered-on capped by `subscription_quantity`. See [/pricing](/pricing) and [/blog/hard-paywall-is-live](/blog/hard-paywall-is-live).
